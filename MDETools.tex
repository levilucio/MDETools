...
Sudeep Kanaav \and Andreas Bayha \and Johannes Eder} 
%
...
\email{\{lucio,kanav,bahya,eder\}@fortiss.org}}
%
...
for a real-life rover and have downsized and adapted it to control a rover in a
virtual environment. The model we present here automates the maneuvering
a rover to follow another leader rover in the virtual environment, while
